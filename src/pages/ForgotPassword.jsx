...
export default function ForgotPassword() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      toast.success("Email was sent, please check email or spam folder too");
      navigate("/sign-in");
    } catch (error) {
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-10">
          <form onSubmit={onSubmit}>
            <input
              id="email"
              type="email"
              className="w-full rounded transition ease-in-out px-3 text-gray-700 border-gray-300 mb-6"
            ...
            <div className="flex justify-between mb-6">
              <p>
                ...
                <Link
                  to="/sign-up"
                  className="capitalize text-red-600 hover:text-red-700 transition duration-100"
                >
                  register
                </Link>
              </p>
              <p>
                <Link
                  to="/sign-in"
                  className="capitalize text-blue-600 hover:text-blue-700 transition duration-100"
                >
                  sign in instead
                </Link>
              </p>
            ...
            <button
              type="submit"
              className="uppercase w-full bg-blue-600 hover:bg-blue-700 text-white text-sm py-3 rounded-md shadow-sm hover:shadow-md"
            >
              send reset email
            </button>
