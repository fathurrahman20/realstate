            ...
            <div className="flex flex-wrap justify-center max-w-6xl px-6 py-12 items-center mx-auto">
                ...
                <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-10">
                    <form>
                        ...
                        <button type="submit" className="uppercase w-full bg-blue-600 hover:bg-blue-700 text-white text-sm py-3 rounded-md shadow-sm hover:shadow-md">sign in</button>
